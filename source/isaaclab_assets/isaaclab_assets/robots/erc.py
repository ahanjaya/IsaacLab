...
# NXP Humanoid Robot Full Size Configuration [URDF]
...
# NXP Lower Body Closed Loop Configuration [OnShape]
NXP_LOWER_BODY_CLOSED_LOOP_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=os.path.join(
            os.getcwd(),
            NXP_DIR,
...
# NXP Humanoid Robot Full Size Configuration [OnShape]
NXP_HUMANOID_CLOSED_LOOP_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=os.path.join(
            os.getcwd(),
            NXP_DIR,
            "nxp_humanoid_closed_loop/nxp_humanoid_edit.usd",
        ),
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            ...
            "left_shoulder_yaw_joint": 0.13,  # 7.5 degrees
            "right_shoulder_yaw_joint": -0.13,  # -7.5 degrees
            "left_elbow_joint": -0.52,  # -30 degrees
            "right_elbow_joint": 0.52,  # 30 degrees
            "head_.*": 0.0,  # 0 degrees
        },
        joint_vel={".*": 0.0},
    ),
