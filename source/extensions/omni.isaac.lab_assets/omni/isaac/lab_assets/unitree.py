...
UNITREE_A1_DIR = "source/extensions/omni.isaac.lab_assets/data/Robots/Unitree/A1"
...
UNITREE_A1_ANIM_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=os.path.join(os.getcwd(), UNITREE_A1_DIR, "a1_no_collision.usd"),
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
UNITREE_A1_UNINSTANCEABLE_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=os.path.join(os.getcwd(), UNITREE_A1_DIR, "a1_uninstanceable.usd"),
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
