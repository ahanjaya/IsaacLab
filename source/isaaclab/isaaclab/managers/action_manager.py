...
class ActionManager(ManagerBase):
    ...
    * apply actions: This operation typically sets the processed actions into the assets in the
    ...
    def __init__(self, cfg: object, env: ManagerBasedEnv):
        ...
        self._prev_two_action = torch.zeros_like(self._action)
    ...
    def reset(self, env_ids: Sequence[int] | None = None) -> dict[str, torch.Tensor]:
        ...
        self._prev_two_action[env_ids] = 0.0
    ...
    def process_action(self, action: torch.Tensor):
        ...
        self._prev_two_action[:] = self._prev_action
