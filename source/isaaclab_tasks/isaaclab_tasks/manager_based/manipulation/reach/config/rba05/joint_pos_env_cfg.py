...
# Pre-defined configs
##
from isaaclab_assets import RBA05_CFG  # isort: skip
...
@configclass
class RBA05ReachEnvCfg(ReachEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.robot = RBA05_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        # override events
...
@configclass
class RBA05ReachEnvCfg_PLAY(RBA05ReachEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
