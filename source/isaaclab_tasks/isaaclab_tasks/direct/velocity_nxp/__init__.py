...
gym.register(
    id="Isaac-Velocity-Rough-NXP-Lower-Body-Direct-v0",
    entry_point=f"{__name__}.velocity_nxp_env:VelocityNXPLowerBodyFlatEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.velocity_nxp_env:VelocityNXPLowerBodyRoughEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:VelocityNXPLowerBodyRoughPPORunnerCfg",
    },
)
